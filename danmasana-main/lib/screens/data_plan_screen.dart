                    ...
                    children: [
                        ...
                        onTap: () {
                          _showBottomSheet(
                            ...
                            onItemSelected: (newValue) {
                              setState(() {
                                // Set selectedNetwork to the ID and selectedNetworkName to the name
                                ...
                                selectedNetworkName = selectedProvider['name'];
                                selectedDataType = null;
                                selectedDataPlan = null;
                              });
                              fetchDataTypes();
                      ...
                      GestureDetector(
                        ...
                        child: Container(
                          ...
                          child: Text(
                            selectedDataType ?? 'Select Data Type',
                            style: TextStyle(color: Colors.blue[900]),
